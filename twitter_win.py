...
chromedriver_path = 'C:\\Users\\Tima\\Desktop\\Allison_RA\\twitter_parser\\chromedriver.exe'
...
with open(f'C:\\Users\\Tima\\Desktop\\Allison_RA\\twitter_parser\\names_.csv', encoding='utf-8-sig') as fin:
        all_names = dict()
...
with open(f'C:\\Users\\Tima\\Desktop\\Allison_RA\\twitter_parser\\left.csv') as fin:
...
for ticker, since_, until_, names in req_params[78:81]:
    ...
    for name in names:
        ...
        while 'Попробуйте перезагрузить страницу.' in driver.page_source:
        ...
        keys = tweets[0].keys()
        with open(f'C:\\Users\\Tima\\Desktop\\left_new\\{ticker}_{since_}_{until_}.csv', 'w', newline='', errors='ignore') as output_file:
